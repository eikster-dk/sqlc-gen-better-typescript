...
func loadTemplates(log *logger.Logger) (*templateSet, error) {
	funcMap := template.FuncMap{"splitLines": splitLines, "formatImports": formatImports}
	...
	return &templateSet{models: modelsTmpl, request: requestTmpl, response: responseTmpl, repository: repositoryTmpl}, nil
}
