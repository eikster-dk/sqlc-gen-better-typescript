...
// DeleteCustomerResult - Parameters Schema
export const DeleteCustomerResultParams = Schema.Struct({
  id: Schema.Int,
})

export type DeleteCustomerResultParams = typeof DeleteCustomerResultParams.Type
