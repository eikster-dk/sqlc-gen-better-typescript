...
const ordersRepositoryImpl = Effect.gen(function* () {
  ...
  const getOrder = SqlSchema.findOneOption({
    ...
    execute: (params) => sql.unsafe(`SELECT id, customer_id, status, total_cents, shipping_address, billing_address, notes, created_at, updated_at
FROM orders
WHERE id = $1`, [params.id])
  ...
  const getOrderWithCustomer = SqlSchema.findOneOption({
    ...
    execute: (params) => sql.unsafe(`SELECT
...
WHERE o.id = $1`, [params.id])
  ...
  const listOrders = SqlSchema.findAll({
    ...
    execute: () => sql.unsafe(`SELECT id, customer_id, status, total_cents, shipping_address, billing_address, notes, created_at, updated_at
FROM orders
...
LIMIT $1`, [params.limit])
  ...
  const searchOrders = SqlSchema.findAll({
    ...
    execute: (params) => sql.unsafe(`SELECT id, customer_id, status, total_cents, shipping_address, notes, created_at
FROM orders
...
ORDER BY created_at DESC`, [params.websearchToTsquery])
  ...
  const createOrder = SqlSchema.findOneOption({
    ...
    execute: (params) => sql.unsafe(`INSERT INTO orders (customer_id, status, shipping_address, billing_address, notes)
VALUES ($1, $2, $3, $4, $5)
RETURNING id, customer_id, status, total_cents, shipping_address, billing_address, notes, created_at, updated_at`, [params.customerId, params.status, params.shippingAddress, params.billingAddress, params.notes])
  ...
  const updateOrderStatus = SqlSchema.void({
    ...
    execute: (params) => sql.unsafe(`UPDATE orders
...
WHERE id = $1`, [params.id])
  ...
  const countOrdersByStatus = SqlSchema.findAll({
    ...
    execute: () => sql.unsafe(`SELECT status, COUNT(*) AS order_count
FROM orders
GROUP BY status
...
WHERE id = $1`, [params.id])
  ...
  const listOrderLines = SqlSchema.findAll({
    ...
    execute: (params) => sql.unsafe(`SELECT id, order_id, product_id, quantity, unit_price_cents, discount_cents, created_at
FROM order_lines
WHERE order_id = $1
...
ORDER BY ol.created_at`, [params.id])
  ...
  const createOrderLine = SqlSchema.findOneOption({
    ...
    execute: (params) => sql.unsafe(`INSERT INTO order_lines (order_id, product_id, quantity, unit_price_cents, discount_cents)
VALUES ($1, $2, $3, $4, $5)
RETURNING id, order_id, product_id, quantity, unit_price_cents, discount_cents, created_at`, [params.orderId, params.productId, params.quantity, params.unitPriceCents, params.discountCents])
  ...
  const updateOrderLineQuantity = SqlSchema.void({
    ...
    execute: (params) => sql.unsafe(`UPDATE order_lines
SET quantity = $2
...
LIMIT $1`, [params.limit])
  ...
  const getOrdersByProductIds = SqlSchema.findAll({
    ...
    execute: (params) => sql.unsafe(`SELECT DISTINCT o.id, o.customer_id, o.status, o.total_cents, o.created_at
FROM orders o
JOIN order_lines ol ON o.id = ol.order_id
WHERE ol.product_id = ANY($1::int[])
ORDER BY o.created_at DESC`, [params.productIds])
  })
