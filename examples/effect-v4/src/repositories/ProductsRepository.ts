...
// Service Tag
export class ProductsRepository extends Context.Service<ProductsRepository>()("ProductsRepository", { make: productsRepositoryMake }) {
  static readonly layer = Layer.effect(this, this.make)
}

export type ProductsRepositoryService = ProductsRepository["Service"]

// Live Layer
export const productsRepositoryLive = ProductsRepository.layer
